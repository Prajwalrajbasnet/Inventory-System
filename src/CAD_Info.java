...
public class CAD_Info extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        comboBoxCategory.setBackground(new java.awt.Color(44, 62, 80));
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(comboBoxCategory, javax.swing.GroupLayout.PREFERRED_SIZE, 202, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        btnDelete.setBackground(new java.awt.Color(247, 145, 45));
        btnDelete.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        btnDelete.setForeground(new java.awt.Color(255, 255, 255));
        btnDelete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/delete-button.png"))); // NOI18N
        ...
        CmbBoxSearchBy.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Name", "Quantity", "Price", "Category", "Range" }));
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(CmbBoxSearchBy, javax.swing.GroupLayout.PREFERRED_SIZE, 99, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void btnQuantityInCategoryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnQuantityInCategoryActionPerformed
        ...
        int[] result = sequentialSearch(list,catKeyword);
        if(result.length==0)
        {
    ...
    private void btnProductsInCategoryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProductsInCategoryActionPerformed
        ...
        else
        {
            ...
            JOptionPane.showMessageDialog(rootPane, "There are total "+result.length+" of this category. "+"And they are: "+names);
            //            System.out.print("There are total "+result.length+" items of this category and they are: ");
            //            for(int i=0; i<result.length; i++)
            //            {
                //                System.out.print(list.get(result[i]).getProductName()+", ");
                //            }
            //            JOptionPane.showMessageDialog(rootPane, "There are total "+result.length+" of this category.");
        ...
        try
        {
            ...
            else
            {
                ...
                if(flag==true)
                {
                    ...
                    model.addRow(new Object [] {productCode, productName, manufacturer, quantity,range, category,price});
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        try{
            ...
            if(result==-1)
            {
                JOptionPane.showMessageDialog(rootPane,"There is no any product with entered price.","Error",JOptionPane.ERROR_MESSAGE);
            }
            else
            {
            ...
            JOptionPane.showMessageDialog(rootPane, "Value expected in number format to search with quantity.", "Error", JOptionPane.ERROR_MESSAGE);
        }
